...
{
    public class TagEditorUtils : BTaggedEditorUtils<TagGroup, Tag>
    {
        public static Tag CreateTag(string groupPath, string tagName, bool createIfAlreadyExists = false) => CreateSO(groupPath, tagName, createIfAlreadyExists);
        public static Tag CreateTag(TagGroup tagGroup, string tagName, bool createIfAlreadyExists = false) => CreateSO(tagGroup, tagName, createIfAlreadyExists);
