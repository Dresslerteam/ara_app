...
namespace BOC.BTagged
{
    ...
    // in order to avoid BTagged having dependency on the entire Entities & Mathematics packages
    [Serializable]
...
#endif
                fixed (Buint4* array = &this) { return ((uint*)array)[index]; }
            }
            set
            {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
    ...
    {
        public override bool Equals(BHash128 b1, BHash128 b2)
        {
            return b1.Equals(b2);
        }

        public override int GetHashCode(BHash128 hash)
        {
    ...
    public struct BHash128 : IEquatable<BHash128>, IComparable<BHash128>
    {
        ...
        public bool Equals(BHash128 obj)
        {
            return x.Equals(obj.x) && y.Equals(obj.y) && z.Equals(obj.z) && w.Equals(obj.w);
        }
        ...
        {
            return obj is BHash128 other && Equals(other);
        }
...
#endif
#if UNITY_ENTITIES
        public static unsafe implicit operator BHash128(Unity.Entities.Hash128 guid) => *(BHash128*)&guid;
        public static unsafe implicit operator Unity.Entities.Hash128(BHash128 guid) => *(Unity.Entities.Hash128*)&guid;
#endif
    }
}
